...
class GrapesDB {
    ...
    public function checkUser($userId, $pass){
        $result = mysql_query("SELECT * FROM `grapes_oauth_users` WHERE username = '".$userId."'");
    ...
    public function addUser($userId, $pass, $nickname, $sex, $phone, $mail, $address, $headicon){
        $sql = "INSERT INTO grapes_oauth_users (".
            " username,".
            " password,".
            " user_nickname,".
            " user_sex,".
    ...
    public function getUsers($count){
        $result = mysql_query("SELECT * FROM `grapes_oauth_users` WHERE 1 LIMIT 0 , ".$count);
        $users = array();
